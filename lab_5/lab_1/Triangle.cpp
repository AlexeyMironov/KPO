...
CMyLongNumber CTriangle::GetSideA() const
{
	return GetLineLength(m_p1, m_p2);
}

CMyLongNumber CTriangle::GetSideB() const
{
	return GetLineLength(m_p2, m_p3);
}

CMyLongNumber CTriangle::GetSideC() const
{
	return GetLineLength(m_p1, m_p3);
}

void CTriangle::Accept(CBodyVisitor &visitor) const
{
