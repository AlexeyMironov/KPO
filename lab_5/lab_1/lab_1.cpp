...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	while (!inFile.eof())
	{
		...
		CPerimeterVisitor perimeterVisitor;
		body->Accept(perimeterVisitor);

		CAreaVisitor areaVisitor;
		body->Accept(areaVisitor);

		cout << typeBody << " P = " << perimeterVisitor.result << "; S = " << areaVisitor.result << endl;
		outFile << typeBody << " P = " << perimeterVisitor.result << "; S = " << areaVisitor.result << endl;
